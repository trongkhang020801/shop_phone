...
function addThongKe() {
  ...
  var dataChart1 = {
    ...
    data: {
      ...
      datasets: [
        {
          label: "Số lượng bán ra",
          data: [5, 22, 11, 15, 21, 7, 5, 15, 14, 18, 19, 12],
          backgroundColor: [
            "rgba(255, 99, 132, 0.2)",
            "rgba(54, 162, 235, 0.2)",
            "rgba(255, 206, 86, 0.2)",
  ...
  var doughnutChart = copyObject(dataChart1);
...
function addKhungSuaSanPham(masp) {
  ...
  var s =
    ...
    `</th>
            ...
            <tr>
                <td>Mã sản phẩm:</td>
                <td><input disabled="disabled" type="text" id="maspSua" name="maspSua" value="` +
    sp.MaSP +
    `"></td>
            </tr>
            <tr>
