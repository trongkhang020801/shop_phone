...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th1 03, 2022 lúc 03:08 AM
...
INSERT INTO `danhgia` (`MaSP`, `MaND`, `SoSao`, `BinhLuan`, `thoigian`) VALUES
(4, '2', 4, 'Hoàng trần đẹp trai', ''),
(4, '2', 1, 'Chưa tốt! cần cải thiện nhiều', ''),
(2, '2', 4, 'Giảm giá 500k , quá gắt <3', ''),
(46, '2', 4, 'Đỏ may mắn <3', ''),
(44, '4', 5, 'wow, giá rẻ cấu hình ngon đây rồi <3', ''),
(4, '4', 4, 'đẹp', ''),
(2, '4', 3, 'aaa sơn cmn tùng <3', ''),
(44, '4', 3, 'Ram có 1GB tiếc quá', ''),
(46, '4', 2, 'Pin khá tệ ', ''),
(15, '4', 4, 'mua vài chục cái về cho con cháu chọi nhau chơi :v', ''),
(5, '1', 5, 'sản phẩm tốt', ''),
(2, '4', 5, 'yêu\n', ''),
(42, '4', 5, 'Sản phẩm tốt', ''),
(4, '4', 0, '2022-01-03 01:25:27', ''),
(44, '4', 4, 'aaa', '2022-01-03 01:29:16');
...
(1, 4, '2021-11-27 12:32:59', 'Nguyễn Huệ', '01207764668', 'aa', 'Qua thẻ ngân hàng', 7190000, '1'),
(2, 4, '2022-01-02 04:35:52', 'Nguyễn Huệ', '01207764668', '01- Trần Cao Vân - Đà Nẵng', 'Trực tiếp khi nhận h', 7190000, '1'),
(3, 2, '2022-01-02 04:37:35', 'Nguyen Danh', '0123456789', 'f', '', 35950000, '1');
...
(1, 'Tran', 'Hoang', '', '0123456789', 'th@gmail.com', '', 'admin', 'admin', 2, 1),
(2, 'Nguyen', 'Danh', '', '0123456789', '', '', 'aaa', '111', 2, 1),
(4, 'Nguyễn', 'Huệ', '', '01207764668', '', '', 'Hue', '111', 1, 1);
...
(2, 7, 'Oppo F9', 7690000, 10, 'img/products/oppo-f9-red-600x600.jpg', 2, 'LTPS LCD, 6.3\', Full HD+', 'ColorOS 5.2 (Android 8.1)', '16 MP và 2 MP (2 camera)', '25 MP', 'MediaTek Helio P60 8 nhân 64-bit', '4 GB', '64 GB', 'MicroSD, hỗ trợ tối đa 256 GB', '3500 mAh, có sạc nhanh', 4, 3, 1),
...
(5, 8, 'Samsung Galaxy J8', 6290000, 10, 'img/products/samsung-galaxy-j8-600x600-600x600.jpg', 2, 'Super AMOLED, 6.0\', HD+', 'Android 8.0 (Oreo)', '16 MP và 5 MP (2 camera)', '16 MP', 'Qualcomm Snapdragon 450 8 nhân 64-bit', '3 GB', '32 GB', 'MicroSD, hỗ trợ tối đa 256 GB', '3500 mAh', 5, 1, 1),
...
(42, 3, 'HTC U12 life', 7690000, 10, 'https://cdn.tgdd.vn/Products/Images/42/186397/htc-u12-life-1-600x600.jpg', 5, 'Super LCD, 6\', Full HD+', 'Android 8.1 (Oreo)', '16 MP và 5 MP (2 camera)', '13 MP', 'Qualcomm Snapdragon 636 8 nhân', '4 GB', '64 GB', 'MicroSD, hỗ trợ tối đa 512 GB', '3600 mAh', 5, 1, 1),
...
(44, 2, 'Coolpad N3', 1890000, 10, 'https://cdn.tgdd.vn/Products/Images/42/193502/coolpad-n3-gray-1-600x600.jpg', 5, 'IPS LCD, 5.45\', HD+', 'Android Go Edition', '5 MP và 0.3 MP (2 camera)', '2 MP', 'Spreadtrum SC9850K 4 nhân', '1 GB', '16 GB', 'MicroSD, hỗ trợ tối đa 32 GB', '2300 mAh', 4, 4, 1),
